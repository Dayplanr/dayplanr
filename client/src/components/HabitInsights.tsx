...
import { Plus, TrendingUp, BarChart3, Target } from "lucide-react";
import {
  BarChart,
  Bar,
  XAxis,
...
export default function HabitInsights({ habits }: HabitInsightsProps) {
    ...
    <>
      <div className="fixed bottom-24 md:bottom-8 left-1/2 -translate-x-1/2 z-40">
        <Button
          ...
          data-testid="button-habit-insights"
        >
